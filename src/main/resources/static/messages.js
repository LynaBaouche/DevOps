document.addEventListener("DOMContentLoaded", () => {
  ...
  const messages = [
    { auteur: "Lyna Baouche", contenu: "Salut ! J’espère que tu vas bien. J’ai terminé la première partie du rapport.", heure: "14:25", type: "received" },
    { auteur: "Moi", contenu: "Parfait ! Je vais le regarder tout de suite. Merci pour ton travail.", heure: "14:27", type: "sent" },
    { auteur: "Lyna Baouche", contenu: "As-tu pu regarder le rapport que j’ai envoyé ? J’aimerais avoir ton avis avant la réunion de demain.", heure: "14:30", type: "received" },
  ];
